    ...
    >
      ...
      >
        <h3 className=" text-lg ">
          {type === "sửa" ? "Sửa" : "Thêm mới"} Nhiệm vụ
        </h3>
        ...
        <div className="mt-8 flex flex-col space-y-1">
          ...
          <input
           ...
           placeholder="e.g Thêm công việc"
          />
        </div>
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          >
           {type === "Sửa" ? "Lưu chỉnh sửa" : "Tạo nhiệm vụ"}
          </button>
        </div>
      </div>
    </div>

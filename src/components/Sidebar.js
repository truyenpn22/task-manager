        ...
        <div>
          ...
          {isSideBarOpen && (
            <div className=" bg-white  dark:bg-[#2b2c37]    w-full   py-4 rounded-xl">
              <h3 className=" dark:text-gray-300 text-gray-600 font-semibold mx-4 mb-8 ">
               TẤT CẢ CÁC BAN ({boards?.length})
              </h3>

              <div className="  dropdown-borad flex flex-col h-[60vh]  justify-between ">
                <div>
                  ...
                  >
                    <img src={boardIcon} className="   filter-white  h-4 " />
                    <p className=" text-lg font-bold  ">Tạo bảng mới</p>
                  </div>
                </div>
          ...
          {isSideBarOpen ? (
            ...
            >
              ...
              />
              {isSideBarOpen && <p> Ẩn thanh bên </p>}
            </div>
          ) : (
